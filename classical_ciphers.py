...
#helper function for the hill cipher, it takes the key as an array of integers and return it in the matrix form
...
#helper function for the Vigenere cipher , it returns the correct key as chosen by the mode
...
def main():
    print("if you want to run the inputs from the files given choose 0")
    print("if you want to run the inputs from the CMD choose 1")
    answer = input()
    mode = int(answer)
    if mode == 0:
         main_files()
        ...
        print("Error! see the screenshots for referencing, the answer is 0 or 1 only")
